...
#define configLFXT_CLOCK_HZ             CONFIG_XT1_CLOCK_HZ

#define configUSE_PREEMPTION			1
#define configTICK_RATE_HZ				( ( TickType_t ) CONFIG_FREERTOS_TICK_RATE_HZ )
#define configMAX_PRIORITIES			( 5 )
#define configTOTAL_HEAP_SIZE			( ( size_t ) ( 8 * 1024 ) )    //MAX 16KB RAM
...
/* Stack Memory */
#define configMINIMAL_STACK_SIZE		( ( unsigned short ) 360 )
...
#define configASSERT( x ) if( ( x ) == 0 ) { taskDISABLE_INTERRUPTS(); while(1){P4OUT^=(BIT7|BIT6|BIT5);__delay_cycles(25000000>>4);}; }
