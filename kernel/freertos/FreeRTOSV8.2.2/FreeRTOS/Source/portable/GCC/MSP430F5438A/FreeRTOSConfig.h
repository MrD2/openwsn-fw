...
// Set this option if you use a vertion older than FreeRTOS v8
// OR, if you are not lazy, replace the types defined in this website:
...
#define configTOTAL_HEAP_SIZE			        ( ( size_t ) ( 10 * 1024 ) ) //MAX 16KB RAM
