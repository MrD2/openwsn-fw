...
#define portSAVE_CONTEXT()									\
	__asm__ __volatile__ ( "PUSHX.A	#12, r15	\n\t"		\
						   "PUSHX.W	%0			\n\t"		\
						   "MOVA	%1, r12		\n\t"		\
						   "MOVA	r1, @r12	\n\t"		\
						   :								\
...
#define portRESTORE_CONTEXT()								\
	__asm__ __volatile__ ( "MOVA	%1, r12		\n\t"		\
						   "MOVA	@r12, r1	\n\t"		\
	                       "POPX.W	%0			\n\t"		\
						   "POPM.A	#12, r15	\n\t"		\
						   "BIC		%2, @r1		\n\t"		\
...
/*
 * Hardware initialisation to generate the RTOS tick.  Since openwsn
 * makes use of timer A0 and B0 we will use timer A1
 */
static void prvSetupTimerInterrupt( void )
{
 ...
 */
	 ...
	 */
	void __attribute__((__interrupt__ (TIMER1_A1_VECTOR))) __MSPGCC_MAYBE_C16__ (TIMERA1_ISR)(void){
